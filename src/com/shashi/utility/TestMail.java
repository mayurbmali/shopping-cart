	...
	public static void main(String[] args) {
		try {
			...
			String htmlTextMessage = "" + "<html>"
					...
					+ "<h2 style='color:red;'>Welcome to TechBazaar</h2>" + "<p>Hey,<br>"
					+ "Thanks for singing up with TechBazaar.<br>"
					...
					+ "<span class='greenText'>TechBazaar500</span><br><br>" + "Have a good day!<br>" + "</p>" + "</body>"
					+ "</html>";
